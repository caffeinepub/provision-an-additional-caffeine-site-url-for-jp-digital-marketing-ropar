...
export class Backend implements backendInterface {
    ...
    async configureDomain(arg0: string): Promise<void> {
    ...
    async getDomain(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDomain();
    ...
    async getSubdomain(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubdomain();
                return from_candid_opt_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async publish(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.publish(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetSiteStorage(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetSiteStorage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
